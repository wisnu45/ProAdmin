...
if (!function_exists('get_avatar')) {
    ...
    function get_avatar($image_name = "") {
        if ($image_name==="system_bot") {
            return iaBase()."assets/images/avatar-bot.jpg";
        } else if ($image_name) {
            return iaBase()."assets/images/". $image_name;

           // return base_url(get_setting("profile_image_path")) . "/" . $image_name;
        } else {
            return iaBase()."assets/images/avatar.jpg";
        }
    }
...
if (!function_exists('get_team_member_profile_link')) {
    ...
    function get_team_member_profile_link($id = 0, $name = "", $attributes = array()) {
        $ci = get_instance();
        if ($ci->session->get_userdata()['user_details'][0]->ia_users_id === "staff") {
...
if (!function_exists('log_notification')) {
    ...
    function log_notification($event, $options = array(), $user_id = 0) {
        ...
        $url = base_url(). "notification_processor/create_notification"; 
        ...
        if ($user_id) {
            ...
            $req .= "&user_id=" . $ci->session->get_userdata()['user_details'][0]->ia_users_id;
        }
