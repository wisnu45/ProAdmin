<div id="new-message-dropzone" class="post-dropzone">
    <?php echo form_open(get_uri("messages/sendmessage"), array("id" => "message-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var validationUrl = "<?php echo get_uri("messages/validatemessagefile"); ?>";
