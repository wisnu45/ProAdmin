    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <li class="<?=($this->router->method === "dashboard") ? "active" : "not-active"?>">
                <a href="<?php echo base_url('dashboard'); ?>"> <i class="material-icons">dashboard</i> <span><?php echo lang("dashboard"); ?></span></a>
            </li>
            ...
            <li class="<?=($this->router->method === "profile") ? "active" : "not-active"?>" style="display: none;">
                ...
                <span><?php // echo lang("profile"); ?></span></a>
                    ...
                    <li class="<?=($this->router->method === "userlist") ? "active" : "not-active"?>">
                        <a href="<?php echo base_url(); ?>user/userlist" class="EditCrud" data-crud_id="24599">
                    ...
                    <li class="<?=($this->router->class === "plugins") ? "active" : "not-active"?>">
                        <a href="<?php echo base_url("plugins"); ?>"><i class="material-icons">extension</i> <span><?php echo lang('plugins'); ?></span></a>
                    </li>
