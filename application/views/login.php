	            ...
	            <div class="body">
	                <form action="<?php echo base_url() . 'user/authUser'; ?>" method="post" id="login-form">
	                    ...
	                    <div class="input-group">
	                        ...
	                        <div class="form-line">
	                        	<input type="text" name="email" class="form-control" id="" placeholder="<?php echo lang('email'); ?>" required value="admin@admin.com" autofocus>
	                        </div>
	                    </div>
	                    <div class="input-group">
	                        <span class="input-group-addon">
	                        ...
	                        <div class="form-line">
	                            <input type="password" name="password" class="form-control" id="pwd" placeholder="<?php echo lang('password'); ?>" value="123456" required>
	                        </div>
	                    </div>
	                    <div class="row">
                            <div class="col-md-12">
